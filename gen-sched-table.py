...
"""
    ...
    while d <= semester_end:
        ...
        if d.weekday() == rec_day0 and d >= recitation_start and d <= recitation_end:
            ...
            print("   <div class=\"col-sm-2\">%d/%d</div>" % (d.month, d.day))
            if specialLec is None:
                print("   <div class=\"col-sm-3\"><a href=\"https://github.com/nyu-cso-sp19/cso19sp-recitation/tree/slides/r%02d/r%02d.pdf\"><em>recitation%02d</em></a></div>" % (recitation, recitation, recitation))
